...
function ProjectCard({ p, i }) {
  ...
  return (
    <motion.div
      ...
      style={{ background: '#1C1C1A', borderColor: '#3A3A38', transition: 'border-color 0.3s ease, box-shadow 0.3s ease, transform 0.35s cubic-bezier(0.25,0.46,0.45,0.94)' }}>
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <motion.a href={p.github || 'https://github.com/Milharabhagya'}
          ...
          className="text-lg" style={{ color: '#5F5E5A' }}>↗</motion.a>
      </div>
